            ...
            <div class="listing-data">
                <div class="listing-basicinfo">
                    ...
                    <div class="listing-attributes">
                        <span class="category"><strong><?php _e('Category','osclasswizards');?>:</strong> <?php echo osc_premium_category() ; ?></span> -
                        <span class="location"><strong><?php _e('Location', 'osclasswizards');?>:</strong> <?php echo osc_premium_city(); ?> <?php if(osc_premium_region()!='') { ?>(<?php echo osc_premium_region(); ?>)<?php } ?></span> <span class="g-hide">-</span> <strong><?php _e('Date','osclasswizards');?>:</strong> <?php echo osc_format_date(osc_premium_pub_date()); ?>
                        <?php if( osc_price_enabled_at_items() ) { ?><span class="currency-value"><strong><?php _e('Price','osclasswizards');?>:</strong> <?php echo osc_format_price(osc_premium_price()); ?></span><?php } ?>
                    </div>
                ...
                <?php if($admin){ ?>
                    <span class="admin-options">
                        <a href="<?php echo osc_premium_edit_url(); ?>" rel="nofollow"><?php _e('Edit item', 'osclasswizards'); ?></a>
                        <span>|</span>
                        <a class="delete" onclick="javascript:return confirm('<?php echo osc_esc_js(__('This action can not be undone. Are you sure you want to continue?', 'osclasswizards')); ?>')" href="<?php echo osc_premium_delete_url();?>" ><?php _e('Delete', 'osclasswizards'); ?></a>
                        <?php if(osc_premium_is_inactive()) {?>
                        <span>|</span>
                        <a href="<?php echo osc_premium_activate_url();?>" ><?php _e('Activate', 'osclasswizards'); ?></a>
                        <?php } ?>
                    </span>
                <?php } ?>
            </div>
