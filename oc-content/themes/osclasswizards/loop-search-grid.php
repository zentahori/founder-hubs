...
?>
<div id="listing-card-list" class="row listing-card-list listings_grid listings_grids">
  <?php
	$i = 0;
...
?>
  ...
  <li class="listing-card col-sm-6 col-md-3 <?php if(osc_item_is_premium()){ echo ' premium'; } ?>">
...
?>
  <?php $size = explode('x', osc_thumbnail_dimensions()); ?>
  <li class="listing-card col-sm-6 col-md-3 premium">
    <?php if( osc_images_enabled_at_items() ) { ?>
